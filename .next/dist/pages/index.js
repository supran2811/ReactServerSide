...
var IndexPage = function (_React$Component) {
    ...
    (0, _createClass3.default)(IndexPage, [{
        ...
        value: function render() {
            return _react2.default.createElement('div', null, _react2.default.createElement('h1', null, 'The main page'), _react2.default.createElement('p', null, 'Go to ', _react2.default.createElement(_link2.default, { href: '/auth' }, _react2.default.createElement('a', null, 'Index Page - ', this.props.appName))), _react2.default.createElement('button', { onClick: function onClick() {
        ...
        value: function getInitialProps(context) {
            var promise = new _promise2.default(function (resolve, reject) {
                setTimeout(function () {
                    return resolve({ appName: "Next App" });
                }, 4000);
            });
